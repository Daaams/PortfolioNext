                ...
                <div className="bg-[#2541B2] rounded-xl p-6 m-5 md:m-0">
                    ...
                    <div className="mt-[3%] pb-[2%] mx-5 md:text-2xl text-white">
                        <p>
                            ...
                            I would like to be able to have informations,  knowledges that I am looking for at my fingertips. D&apos;ont you ? The knowledge transmission with simplicity and in a few clicks is one of my priorities.
